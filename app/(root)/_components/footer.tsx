...
function Footer() {
	return (
		<footer className='bg-white border-t border-gray-200 '>
			<div className='max-w-6xl mx-auto py-6 flex items-center flex-col gap-5'>
				...
				<div className='flex items-center justify-center gap-3'>
					<Link href={' https://t.me/+YxcZinRR7KNhNWFi '}>
						<Image src='/mes/telegram.png' alt='insta' width={30} height={30} />
					</Link>
					<Link href={'https://www.youtube.com/@BeshBolaBuildings'}>
						<Image src='/mes/youtube.png' alt='insta' width={30} height={30} />
					</Link>
					<Link
						href={
					...
					>
						<Image src='/mes/facebook.png' alt='insta' width={30} height={30} />
					</Link>
