      ...
      '
								>
									<p className='text-[13px] md:text-sm leading-relaxed font-work text-white'>
										Majmua rivojlangan infratuzilmaga ega. Avtomobillar uchun
										keng avtoturargohlar, zamonaviy liftlar va xavfsizlik
										tizimlari.
									</p>
							...
							>
								...
								<div className='flex flex-col gap-3 text-sm'>
									...
									<p className='text-gray-600'>
										...
										yashil hududlar va ochiq maydonlar mavjud. Bu joylarda siz
										va oilangiz uchun dam olish,
									</p>
								</div>
							</motion.div>
						</div>
					...
					<div className='flex flex-col items-start gap-3 self-start order-1 lg:order-2'>
						<div className='relative overflow-hidden'>
							...
							>
								...
								<div className='flex flex-col gap-3 text-sm'>
									<p className='text-gray-600'>
										Turar-joy majmuasi togʻ bagʻridagi musaffo havoga boy
										maskanda qurilmoqda. Hovliga begonalar kirishi qatʼiyan
										taqiqlanadi.
									</p>
									<p className='text-gray-600'>
