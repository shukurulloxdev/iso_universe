...
function Page() {
	return (
		<div className='max-w-6xl mx-auto mt-24 md:mt-28 max-md:px-3 '>
			<div className='w-full mx-auto rounded-3xl overflow-hidden bg-[#E6F57A] relative'>
				{/* Background circles */}
				...
				<div className='relative z-10 flex items-center justify-between p-6 md:p-8'>
					...
					<div className='space-y-4'>
						<p className='text-sm font-medium text-black/70'>Progress</p>
